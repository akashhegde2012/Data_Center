CREATE TABLE `Departments` (
  ...
  `Year of Establishment` varchar(200) DEFAULT NULL,
  `Names of programmes` varchar(200) DEFAULT NULL,
  `Number of teaching posts Sanctioned/Filled` varchar(250) DEFAULT NULL,
  `Number of students enrolled` varchar(250) DEFAULT NULL,
  `Number of Research Projects:` varchar(250) DEFAULT NULL,
  `Total grants received` varchar(250) DEFAULT NULL,
  `Inter–institutional collaborative projects and Associated grants` varchar(200) DEFAULT NULL,
  `National collaboration` varchar(500) DEFAULT NULL,
  `International collaboration` varchar(500) DEFAULT NULL,
  `Departmental projects funded by DST-FIST, DBT, ICSSR,etc:` varchar(500) DEFAULT NULL,
  `Special research laboratories created by industry or corporate` varchar(250) DEFAULT NULL,
  `Number of Papers published` varchar(200) DEFAULT NULL,
  `Number of Books with ISBN` varchar(200) DEFAULT NULL,
  `Number of Citation Index–range/average` varchar(250) DEFAULT NULL,
  `Number of Impact Factor–range/average` varchar(250) DEFAULT NULL,
  `Number of h-index` varchar(250) DEFAULT NULL,
  `Details of patents and income generated` varchar(500) DEFAULT NULL,
  `Areas of consultancy and income generated` varchar(500) DEFAULT NULL,
  `Faculty awards` varchar(250) DEFAULT NULL,
  `Doctoral/Post doctoral fellows awards` varchar(250) DEFAULT NULL,
  `Students awards` varchar(500) DEFAULT NULL,
  `How many students have cleared Civil Services and Defense` varchar(250) DEFAULT NULL,
  `No of Research Scholars/PG students getting financial assistance` varchar(250) DEFAULT NULL,
  primary key ( Dept_name,Year)
);

INSERT INTO `Departments` (`Dept_name`,`Year`,`Year of Establishment`, `Names of programmes`, `Number of teaching posts Sanctioned/Filled`, `Number of students enrolled`, `Number of Research Projects:`, `Total grants received`, `Inter–institutional collaborative projects and Associated grants`, `National collaboration`, `International collaboration`, `Departmental projects funded by DST-FIST, DBT, ICSSR,etc:`, `Special research laboratories created by industry or corporate`, `Number of Papers published`, `Number of Books with ISBN`, `Number of Citation Index–range/average`, `Number of Impact Factor–range/average`, `Number of h-index`, `Details of patents and income generated`, `Areas of consultancy and income generated`, `Faculty awards`, `Doctoral/Post doctoral fellows awards`, `Students awards`, `How many students have cleared Civil Services and Defense`, `No of Research Scholars/PG students getting financial assistance`) VALUES
